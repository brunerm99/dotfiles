...
def autostart():
    subprocess.run("/home/marchall/.config/qtile/autostart.sh")
...
keys = [
    ...
    Key([mod], "d", lazy.spawn("rofi -show run"), desc="Spawn rofi app launcher"),
    Key(
        [mod],
        "u",
        lazy.spawn("rofi-pwr"),
    ...
    Key(
        [mod],
        "t",
        lazy.spawn("/home/marchall/.config/eww/scripts/volume toggle notify"),
    ),
